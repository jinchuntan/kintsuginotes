 ...
 *
 * Supports: Groq (recommended), OpenAI, or Anthropic.
 * Falls back to high-quality mock data if no API key is set.
 *
 * To enable AI:
 * 1. Set AI_PROVIDER in .env.local (groq, openai, or anthropic)
          ...
          messages: [
            {
              role: "system",
              content:
                "You are an expert tutor. Always respond with valid JSON only, no markdown fences.",
            },
